...
public final class RussianAnalyzer extends StopwordAnalyzerBase
{
    ...
    public RussianAnalyzer(Version matchVersion, boolean caseSensitive) {
      this(matchVersion,
        matchVersion.onOrAfter(Version.LUCENE_31) ? DefaultSetHolder.DEFAULT_STOP_SET
            : DefaultSetHolder.DEFAULT_STOP_SET_30, caseSensitive);
    }
     ...
     *          a stopword set
     */
    public RussianAnalyzer(Version matchVersion, CharArraySet stopwords, boolean caseSensitive){
      this(matchVersion, stopwords, CharArraySet.EMPTY_SET, caseSensitive);
    }
     ...
     */
    public RussianAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet stemExclusionSet, boolean caseSensitive){
    ...
    protected TokenStreamComponents createComponents(String fieldName,
      ...
      if (matchVersion.onOrAfter(Version.LUCENE_31)) {
        ...
        return new TokenStreamComponents(source, result);
    	  ...
    	  System.err.println("Support LUCENE 3.1 or Higher!");
    	  return null;
      }
    }
}
