...
public class SyncDataSignatureHandlerOut implements SOAPHandler<SOAPMessageContext> {
	
	private static Log log = LogFactory.getLog(SyncDataSignatureHandlerOut.class);
