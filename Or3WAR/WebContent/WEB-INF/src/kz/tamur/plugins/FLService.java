...
public class FLService extends Thread implements ClientPlugin {
    private static String endpoint = null;
    private static int timeout = 10000;
    private static int times = 10;
    private static Log log = LogFactory.getLog((UserSession.SERVER_ID != null ? (UserSession.SERVER_ID + ".") : "") + FLService.class.getName());
    //Constants
    ...
    private static synchronized void loadProperties() {
    	if (endpoint == null) {
            try {
                ...
                File cf = new File(WebController.APP_HOME + "/" + transportPath);
                if (cf.exists()) {
	            ...
	            if ("0".equals(response)) {
	                ...
	                if (pilt.getItem() != null && pilt.getItem().length > 0) {
	                    ...
	                    if (docObj instanceof PersonDocumentType) {
	                        ...
	                        response = "1";
	                        info = "�������� �� ������������ (��� " + ((IrrelevantPersonDocumentType) docObj).getValidityCode() + ")";
	                    } else {
	                    	response = "1";
	                    	info = "�������� �� ������";
	                    }
...
//                    "", endpoint);
    ...
    public int waitTimeOut(int time, int times2) {
        if (times2 >= times) return 1;
