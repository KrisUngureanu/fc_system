...
<link rel="stylesheet" type="text/css" href="<%=pathCSS%>uiv<%=theme%>.css?2020-10-14">
...
<link rel="stylesheet" type="text/css" href="<%=pathCSS%>ap.css?v=2018-11-07">
...
<script type="text/javascript" src="<%=pathJS%>jquery.easyui.min.js?v=2020-10-14"></script>
...
<% } %>
		...
		<div id="processesList" style="width: 100%; display: none; padding: 10px 30px 30px 10px; box-sizing: border-box;" class='appwin'>
			<div class="easyui-panel" data-options="fit:true,border:false">
				<div id="allProcesses_Layout" class="easyui-layout" data-options="fit:true,border:false">
					<div id="favoriteProcesses" data-options="hideCollapsedContent:true,region:'north',split:true,maxHeight:234,minHeight:234,border:false,hideExpandTool:true">
	...
	<script type="text/javascript" src="<%=pathJS%>app.js?v=2020-10-14"></script>
	<script type="text/javascript" src="<%=pathJS%>grid.editors.js?v=v"></script>
	<script type="text/javascript" src="<%=pathJS%>grid.formatter.js?v=2020-10-14"></script>
	<% if (activateChat) { %>
