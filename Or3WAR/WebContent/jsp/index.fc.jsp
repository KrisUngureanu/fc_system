...
//        m.put("menu.main",true);
        ...
        String logoImg = "<img src='" + (logoPath == null ? "media/img/logo-0-fc.png" : logoPath) + "'/>";
...
<link rel="stylesheet" type="text/css" href="<%=pathCSS%>fc.css?v=2020-12-18">
<% if (activateChat) { %>
...
<% } %>
	...
	<nav id="left-panel"
		...
		<% if (showPing) { %>
		<div class="sysinfo server-ping"><%=Funcs.sanitizeXml(rb.getString("pingTime"))%>: <span id="ping" class="badge badge-success"></span> мс</div>
	...
	<script type="text/javascript" src="<%=pathJS%>app.gis.js?v=2022-12-13"></script>
	<script type="text/javascript" src="<%=pathJS%>map.js?v=2018-12-23"></script>
	<script type="text/javascript" src="<%=pathJS%>analytic.js?v=2020-12-24"></script>
	...
	<script type='text/javascript' src='<%=pathJS%>ncaLayerOps.2015.js'></script>
</body>
</html>
<%
    }
