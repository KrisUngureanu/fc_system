...
<div id="loginbox">
	...
	<div id='tt' class="easyui-tabs" data-options="plain:true, narrow:true">
		<div title="Логин/Пароль">
			<div style="width: 85%; text-align: center;">
				<img src="<%=webContextName%>/main?loginLogo" <%if(WebController.risType() != "configPic") {%>width="222" height="80"<%}%>>
			</div>
			...
			<div style="text-align: right; padding-right: 50px; padding-top: 10px;">
				<a onclick="forgotPD(0)" style="color: #006dcc;cursor: pointer;">Забыли пароль?</a>
			</div>
	...
	<div class="btnPanel">
		...
		<div id='errmsg' style='color:red;display:none;'>Вы используете неподдерживаемый браузер! Необходимо использовать Mozilla Firefox версии не ниже 69, Google Chrome версии не ниже 35 или Internet Explorer версии не ниже 10!
			<br><a href="<%=webContextName%>/jsp/media/files/Firefox Setup 77.0.1.exe"/>Скачать Firefox 77.0.1</a>
...
<script type='text/javascript' src='<%=pathJS%>ncaLayerOps1.js?v=2022-04-15'></script>
...
BrowserDetect.init();
var browser = BrowserDetect.browser+";"+BrowserDetect.version+";"+BrowserDetect.OS+";"+BrowserDetect.mobile;
	...
	$.ajax({
		...
		success : function(data) {
			...
			if (data.additionalInfo) {
	  		...
	  		var content = "<br><a href=\"<%=webContextName%>/jsp/media/files/SetupCSPv6.3_20220903.exe\">Скачать и установить программу для работы с ЭЦП (CryptoSocket, обновлено 03.09.2021)</a>";
	  		$('.tool-help').append($(content));
	  		var content = "<br><a href=\"https://localhost:6127/tumarcsp\">Установить первичное соединение с CryptoSocket</a>";
	  		$('.tool-help').append($(content));
		},
		dataType : 'json',
		async : false
