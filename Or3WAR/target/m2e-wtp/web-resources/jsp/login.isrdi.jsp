...
<%
	...
	*/
    ...
    String logoPath = "media/img/logo-login-isrdi.png";
...
<link rel=" stylesheet" type="text/css" href="<%=pathCSS%>uiv4.css?v=2018-12-20">
...
<div id="loginbox">
	<div id="t1" style="margin:20px;">
		<img src="<%= logoPath %>" class="logo">
		<div id='tt'>
			<div>
				<form id="loginForm" onsubmit="return loginFunc(false);">
				<select id="keyStore" style="width:306px;margin-bottom:10px;padding-left:27px;">
			      <option value="" disabled selected hidden>Хранилище ключей</option>				
				  <option value="AKKaztokenStore">eToken</option>
				  <option value="AKKaztokenStore">Казтокен</option>
				  <option value="PKCS12">Персональный компьютер</option>
				  <option value="AKKZIDCardStore">Удостоверение личности</option>
				</select>
				<input type="text" name="file" class="input" value="" id="file" placeholder="Путь к хранилищу" readonly=true style="width:240px;display:none;" />
				<input type="button" name="sel" class="button" value="..." id="sel" onclick="selectFile(document.getElementById('file').value);" style="width:29px;padding:0;position:absolute;display:none;" />
...
<script type='text/javascript' src='<%=pathJS%>ncaLayerOps.js?v=2018-12-20'></script>
