...
jQuery.extend({
	...
	expando: "jQuery" + ( core_version + rndf5() ).replace( /\D/g, "" ),
	...
	var matcherCachedRuns = 0,
		...
		superMatcher = function( seed, context, xml, results, expandContext ) {
			var elem, j, matcher,
				...
				dirrunsUnique = (dirruns += contextBackup == null ? 1 : rndf5() || 0.1);
...
function Data() {
	...
	this.expando = jQuery.expando + rndf5();
}
...
var pow5_2_32 = Math.pow(2,32);
function rndf5() {
	return rnd5()/pow5_2_32;
}