...
<link rel="stylesheet" type="text/css" href="<%=pathCSS%>uiv<%=theme%>.css?2019-07-21">
...
<script type="text/javascript" src="<%=pathJS%>jquery.easyui.min.js?v=2019-05-20"></script>
...
<% } %>
	...
	<script type="text/javascript" src="<%=pathJS%>app.js?v=2019-07-21"></script>
	<script type="text/javascript" src="<%=pathJS%>grid.editors.js?v=2018-08-13"></script>
	...
	<script type="text/javascript" src="<%= pathJS %>tumsocket_or3.js?v=2019-07-02"></script>
</body>
</html>
<%
    }
