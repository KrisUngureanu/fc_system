...
<%
	...
	*/
	...
	String winName = (String)session.getAttribute("winuser");
	String winpc = (String)session.getAttribute("winpc");
	String winDomain = (String)session.getAttribute("windomain");
	
	String winName2 = (String)request.getAttribute("winuser");
	String winpc2 = (String)request.getAttribute("winpc");
	String winDomain2 = (String)request.getAttribute("windomain");
	
	boolean ssoLogin = (winName != null);
	boolean ssoLogin2 = (winName2 != null);
	
	System.out.println("winName = " + winName);
	System.out.println("winDomain = " + winDomain);
	System.out.println("ssoLogin = " + ssoLogin);
	System.out.println("sso = " + request.getParameter("sso"));

	System.out.println("winName2 = " + winName2);
	System.out.println("winDomain2 = " + winDomain2);
	System.out.println("ssoLogin2 = " + ssoLogin2);

	//session.removeAttribute("winuser");
	//session.removeAttribute("winpc");
	//session.removeAttribute("windomain");
...
<div id="loginbox">
	<div style="margin:20px;">
		<img class="logo" src="<%=webContextName%>/main?loginLogo">
...
<% if (ssoLogin2) { %>
	<script>
		var winlogon = '<%= winName %>';
		var domain = '<%= winDomain %>';
		var pc = '<%= winpc %>';
	</script>
	<script type='text/javascript' src='<%=pathJS%>ap.sso.js?v=2020-11-01'></script>
<% } %>
</body>
</html>