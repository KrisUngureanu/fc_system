...
<%
	...
	*/
    ...
    String logoPath = "media/img/logo-fc.png";
...
<link rel="stylesheet" type="text/css" href="<%=pathCSS%>fc.css?v=2022-12-13">
...
<div id="loginbox">
	<div id="t1" style="margin: 40px 20px 0px 20px;">
...
<script type='text/javascript' src='<%=pathJS%>ncaLayerOps.2015.js?v=2022-12-13'></script>
