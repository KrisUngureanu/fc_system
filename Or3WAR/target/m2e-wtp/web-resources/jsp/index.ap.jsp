		...
		<div id="left-panel-content" style="overflow: hidden;">
			<ul
				...
				<li <%if (startHash == null) {%> class="active" <%}%>><a
					...
					href="#cmd=openArch&uid=395455.8656633&id=ui_personInfo" id="ui_personInfo"><%=Funcs.sanitizeXml(rb.getString("webMyProfile"))%></a></li>
				<%
				    if (startHash == null) startHash = "#cmd=openArch&uid=395455.8656633&id=ui_personInfo";
												}
	    			%>
...
<% } %>
	...
	<script type="text/javascript" src="<%=pathJS%>app.js?v=2021-01-22"></script>
