...
//        m.put("menu.main",true);
        ...
        String logoImg = "<img src='" + (logoPath == null ? "media/img/logo-isrdi.png" : logoPath) + "'/>";
...
<link rel="stylesheet" type="text/css" href="<%=pathCSS%>uiv<%=theme%>.css?v=2018-12-17">
...
<link rel="stylesheet" type="text/css" href="<%=pathCSS%>ul.css?v=2018-12-18">
<% if (activateChat) { %>
...
<% } %>
	...
	<nav id="left-panel"
		...
		<div id="left-panel-content" style="">
			<ul
				...
				%>
				<li <%if (startHash == null) {%> class="active" <%}%>><a
					onclick="forseSaveChanges(this); selSect='Кадастровая карта';idSect=-100;"
										...
										<tr>
											<td width="50%">
												<div class="pr">
													...
													<%=userIP%>
													<a href="javascript:generateDocument('security-doc.pdf', 'pdf', 'XmlUtil', 'getFileContent');">
	...
	<script type="text/javascript" src="<%=pathJS%>app.gis.js?v=2019-12-24"></script>
	...
	<script type="text/javascript" src="<%= pathJS %>scanner.socket.js?v=2019-12-23"></script>
</body>
</html>
<%
    }
