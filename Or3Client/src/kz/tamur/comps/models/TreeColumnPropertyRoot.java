...
public class TreeColumnPropertyRoot extends ColumnPropertyRoot {
    public TreeColumnPropertyRoot() {
    	new PropertyNode(getChild("header"), "tipForInput", Types.RSTRING, null, false, null);
        TreeFieldPropertyRoot tfpr = new TreeFieldPropertyRoot();
        ...
        if (constr != null) {
            new PropertyNode(constr.getChildCount() - 1, constr, "unique",
