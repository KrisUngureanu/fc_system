...
public class MemoColumnPropertyRoot extends ColumnPropertyRoot {
    public MemoColumnPropertyRoot() {
        MemoFieldPropertyRoot tfpr = new MemoFieldPropertyRoot();
        ...
        new PropertyNode(view, "showTextAsXML", Types.BOOLEAN, null, false, false);
