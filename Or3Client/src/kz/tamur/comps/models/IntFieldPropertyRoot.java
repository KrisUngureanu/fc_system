 ...
 */
public class IntFieldPropertyRoot extends PropertyRoot {
    public IntFieldPropertyRoot() {
        super();
        ...
        new PropertyNode(view, "formatting", Types.BOOLEAN, null, false, Boolean.TRUE);
        //Поведение
