...
public class FloatColumnPropertyRoot extends ColumnPropertyRoot {
    public FloatColumnPropertyRoot() {
        FloatFieldPropertyRoot ffpr = new FloatFieldPropertyRoot();
        ...
        EnumValue[] env = new EnumValue[] {
            ...
            new EnumValue(Constants.SUMMARY_SUMM, "Сумма"),
            new EnumValue(Constants.SUMMARY_COUNT, "Количество"),
            new EnumValue(Constants.SUMMARY_AVERAGE, "Среднее"),
            new EnumValue(Constants.SUMMARY_MAX, "Максимальное"),
            new EnumValue(Constants.SUMMARY_MIN, "Минимальное")
        };
