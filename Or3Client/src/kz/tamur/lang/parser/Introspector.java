 ...
 * @version $Id: Introspector.java,v 1.2 2015/08/20 10:57:35 erik Exp $
 */
public class Introspector extends IntrospectorBase
{
     ...
     */
    private static Log rlog = LogFactory.getLog((UserSession.SERVER_ID != null ? (UserSession.SERVER_ID + ".") : "") + Introspector.class.getName());
        ...
        throws Exception
    {
        ...
        catch( MethodMap.AmbiguousException ae )
        {
            ...
            for (int i = 0; i < params.length; i++)
            {
                ...
                msg = msg + ((params[i] != null) ? params[i].getClass().getName() : Object.class.getName());
            }
