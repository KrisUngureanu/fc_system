...
public class CmdUndoAction {
	...
	public static void Undo(MainFrame mainFrame) {		
		...
		if (ServiceActionsConteiner.isContein(selectedDocument.getKrnObject().id)) {
			actionsElement = ServiceActionsConteiner.getServiceActions(selectedDocument.getKrnObject().id).getXMLDocumentUndo().getElementsByTagName("actions").item(0);
			actionsElementToSave = ServiceActionsConteiner.getServiceActions(selectedDocument.getKrnObject().id).getXMLDocumentToSave().getElementsByTagName("actions").item(0);
			String nodeID = null;
			String edgeID = null;
			...
			if (actionsElement.hasChildNodes()) {
				...
				ServiceActionsConteiner.getServiceActions(selectedDocument.getKrnObject().id).setMode(2);			
				if (actionsElement.getLastChild().getNodeName().equals("add-node")) {
					...
					isDone = false;
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("add-node")) {
						NodeList addActionElementsToSave = actionsElementToSave.getLastChild().getChildNodes();
						for (int i = 0; i < addActionElementsToSave.getLength(); i++) {
							if (addActionElementsToSave.item(i).getNodeName().equals("node-ID") && addActionElementsToSave.item(i).getTextContent().equals(nodeID)) {
					...
					if (!isDone) {
						ServiceActionsConteiner.getServiceActions(selectedDocument.getKrnObject().id).setMode(6);				
					}	
					...
					isDone = false;
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("drop-node")) {
						NodeList dropActionElementsToSave = actionsElementToSave.getLastChild().getChildNodes();
						for (int i = 0; i < dropActionElementsToSave.getLength(); i++) {
							if (dropActionElementsToSave.item(i).getNodeName().equals("node-ID") && dropActionElementsToSave.item(i).getTextContent().equals(nodeID)) {
								actionsElementToSave.removeChild(actionsElementToSave.getLastChild());
								isDone = true;
							}							
						}
					...
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("change-property")) {
						...
						for (int i = 0; i < changePropertyActionElementsToSave.getLength(); i++) {
							if (changePropertyActionElementsToSave.item(i).getNodeName().equals("node-ID") && changePropertyActionElementsToSave.item(i).getTextContent().equals(nodeID)) {
								actionsElementToSave.removeChild(actionsElementToSave.getLastChild());
								isDone = true;
							}							
						}
					...
					isDone = false;
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("change-location")) {
						NodeList changeLocationActionElementsToSave = actionsElementToSave.getLastChild().getChildNodes();
						for (int i = 0; i < changeLocationActionElementsToSave.getLength(); i++) {
							if (changeLocationActionElementsToSave.item(i).getNodeName().equals("node-ID") && changeLocationActionElementsToSave.item(i).getTextContent().equals(nodeID)) {
								actionsElementToSave.removeChild(actionsElementToSave.getLastChild());
								isDone = true;
							}							
						}
					...
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("add-edge")) {
						NodeList addEdgeLocationActionElementsToSave = actionsElementToSave.getLastChild().getChildNodes();
						for (int i = 0; i < addEdgeLocationActionElementsToSave.getLength(); i++) {
							if (addEdgeLocationActionElementsToSave.item(i).getNodeName().equals("edge-ID") && addEdgeLocationActionElementsToSave.item(i).getTextContent().equals(edgeID)) {
								actionsElementToSave.removeChild(actionsElementToSave.getLastChild());
								isDone = true;
							}							
						}
					...
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("drop-edge")) {
						NodeList dropEdgeLocationActionElementsToSave = actionsElementToSave.getLastChild().getChildNodes();
						for (int i = 0; i < dropEdgeLocationActionElementsToSave.getLength(); i++) {
							if (dropEdgeLocationActionElementsToSave.item(i).getNodeName().equals("edge-ID") && dropEdgeLocationActionElementsToSave.item(i).getTextContent().equals(edgeID)) {
								actionsElementToSave.removeChild(actionsElementToSave.getLastChild());
								isDone = true;
							}							
						}
					...
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("add-point")) {
						NodeList addEdgeLocationActionElementsToSave = actionsElementToSave.getLastChild().getChildNodes();
						for (int i = 0; i < addEdgeLocationActionElementsToSave.getLength(); i++) {
							if (addEdgeLocationActionElementsToSave.item(i).getNodeName().equals("edge-ID") && addEdgeLocationActionElementsToSave.item(i).getTextContent().equals(edgeID)) {
								actionsElementToSave.removeChild(actionsElementToSave.getLastChild());
					...
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("remove-point")) {
						NodeList addEdgeLocationActionElementsToSave = actionsElementToSave.getLastChild().getChildNodes();
						for (int i = 0; i < addEdgeLocationActionElementsToSave.getLength(); i++) {
							if (addEdgeLocationActionElementsToSave.item(i).getNodeName().equals("edge-ID") && addEdgeLocationActionElementsToSave.item(i).getTextContent().equals(edgeID)) {
								actionsElementToSave.removeChild(actionsElementToSave.getLastChild());
					...
					actionsElement.removeChild(replacePointAction);	
					if (actionsElementToSave.hasChildNodes() && actionsElementToSave.getLastChild().getNodeName().equals("replace-point")) {
						NodeList addEdgeLocationActionElementsToSave = actionsElementToSave.getLastChild().getChildNodes();
						for (int i = 0; i < addEdgeLocationActionElementsToSave.getLength(); i++) {
							if (addEdgeLocationActionElementsToSave.item(i).getNodeName().equals("edge-ID") && addEdgeLocationActionElementsToSave.item(i).getTextContent().equals(edgeID)) {
								actionsElementToSave.removeChild(actionsElementToSave.getLastChild());
				...
				ServiceActionsConteiner.getServiceActions(selectedDocument.getKrnObject().id).setMode(1);				
			}			
		}		
	}	
}
