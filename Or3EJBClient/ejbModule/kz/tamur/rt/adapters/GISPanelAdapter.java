...
public class GISPanelAdapter extends ContainerAdapter {
    ...
    private OrGISPanel panel;
    private boolean isEn = true;
    
    private OrCalcRef titleRef;
    private OrCalcRef formulaRef;

    public GISPanelAdapter(UIFrame frame, OrGISPanel panel, boolean isEditor) throws KrnException {
    ...
    public void valueChanged(OrRefEvent e) {
        ...
        if (ref == titleRef) {
    		...
    		if (formulaRef.getValue(langId) != null) {
    			panel.setFormula(formulaRef.getValue(langId).toString());
            }
        }
