...
public class ConvolveFilter extends AbstractBufferedImageOp {
     ...
     * Установить kernel.
     *
     * @param kernel новое значение kernel
     */
    ...
    /**
     * Установить edge action.
     *
     * @param edgeAction новое значение edge action
     */
     ...
     *
     * @param kernel the kernel
     * @param inPixels the in pixels
     * @param outPixels the out pixels
