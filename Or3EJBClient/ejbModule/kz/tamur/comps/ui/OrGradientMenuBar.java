...
/**
 * The Class OrGradientMenuBar.
 *
 * @author Sergey Lebedev
 */
public class OrGradientMenuBar extends JMenuBar {
    ...
    /**
     * Создание нового or gradient menu bar.
     */
    public OrGradientMenuBar() {
        super();
    }
    ...
    /**
     * Установить ориентацию заливки компонента.
     * 
     * @param orientation
     *            the new orientation
     */
