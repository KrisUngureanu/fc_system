...
/**
 * The Class Компонент OrImage.
 */
public class OrImage extends JLabel implements OrGuiComponent, ActionListener {
     ...
     *            the frame
     */
    OrImage(Element xml, int mode, OrFrame frame) {
        super(" ");
        this.mode = mode;
        this.xml = xml;
        this.frame = frame;
        ...
        if (fChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            if (sf != null) {
                ...
                try {
                    ...
                    PropertyHelper.setPropertyValue(new PropertyValue(val, getProperties().getChild("view").getChild("image")),
                            xml, frame);
    ...
    private void getImage() {
        PropertyValue pv = getPropertyValue(getProperties().getChild("view").getChild("image"));
        ImageIcon img = null;
        if (!pv.isNull()) {
