 ...
 */
public class OrRadioButtonMenuItem extends JRadioButtonMenuItem {
     ...
     * @param icon the icon
     */
    public OrRadioButtonMenuItem(Icon icon) {
        super(icon);
    }
     ...
     * @param text the text
     */
    public OrRadioButtonMenuItem(String text) {
        super(text);
    }
     ...
     * @param a the a
     */
    public OrRadioButtonMenuItem(Action a) {
        super(a);
    }
     ...
     * @param icon the icon
     */
    public OrRadioButtonMenuItem(String text, Icon icon) {
        super(text, icon);
    }
     ...
     * @param b the b
     */
    public OrRadioButtonMenuItem(String text, boolean b) {
        super(text, b);
    }
     ...
     * @param b the b
     */
    public OrRadioButtonMenuItem(String text, Icon icon, boolean b) {
        super(text, icon, b);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (isSelected()) {
            g.drawImage(kz.tamur.rt.Utils.getImageIconFull("selectedRadio.png").getImage(), positionCheckX, positionCheckY, null);
        }else {
            g.drawImage(kz.tamur.rt.Utils.getImageIconFull("unSelectedRadio.png").getImage(), positionCheckX, positionCheckY, null);
        }
