...
public class OrFileFilter extends FileFilter {
     ...
     * @see #addExtension
     */
    public OrFileFilter(String extension) {
	this(extension,null);
    }
     ...
     * @see #addExtension
     */
    public OrFileFilter(String extension, String description) {
	this();
     ...
     * @see #addExtension
     */
    public OrFileFilter(String[] filters) {
	this(filters, null);
    }
     ...
     * @see #addExtension
     */
    public OrFileFilter(String[] filters, String description) {
	this();
