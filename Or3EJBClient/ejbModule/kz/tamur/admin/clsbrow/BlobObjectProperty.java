 ...
 */
public class BlobObjectProperty extends ObjectProperty{
    private KrnAttribute attr;

    public BlobObjectProperty(ObjectProperty parent, KrnAttribute attr) {
        super(parent, attr);
        this.attr=attr;
    }
    ...
    public ObjectEditorDelegate createEditorDelegate(JTable table) {
        return new BlobAttrEditorDelegate(table,attr);
    }
