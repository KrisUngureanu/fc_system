 ...
 */
public class DateTimeObjectProperty extends ObjectProperty{
    private KrnAttribute attr;

    public DateTimeObjectProperty(ObjectProperty parent, KrnAttribute attr) {
        super(parent, attr);
        this.attr=attr;
    }
    ...
    public ObjectEditorDelegate createEditorDelegate(JTable table) {
        return new DateTimeAttrEditorDelegate(table,attr);
    }
