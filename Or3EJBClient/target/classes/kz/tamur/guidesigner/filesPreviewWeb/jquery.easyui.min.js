...
var td=$("<td rowspan=\""+opts.frozenColumns.length+"\"><div class=\"datagrid-header-rownumber\">№<br>п/п</div></td>");
if($("tr",t).length==0){
...
if(!_974.nopanel && _974.closed){
_973.panel("panel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.combo.defaults.zIndex++:99)),left:-999999});
...
var tt=[_a76(date!=null?date.getHours():12),_a76(date!=null?date.getMinutes():0)];
if(opts.showSeconds){
tt.push(_a76(date!=null?date.getSeconds():0));
}
