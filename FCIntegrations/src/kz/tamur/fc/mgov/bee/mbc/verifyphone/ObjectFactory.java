...
// Generated on: 2023.09.16 at 12:03:00 AM ALMT 
//


package kz.tamur.fc.mgov.bee.mbc.verifyphone;
 ...
 * generated in the kz.tamur.fc.mgov.bee.mbc.verifyphone package. 
...
public class ObjectFactory {
    ...
    private final static QName _VerifyPhoneResponse_QNAME = new QName("http://mgov.bee.kz/mbc/verifyphone", "verifyPhoneResponse");
    private final static QName _VerifyPhoneRequest_QNAME = new QName("http://mgov.bee.kz/mbc/verifyphone", "verifyPhoneRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: kz.tamur.fc.mgov.bee.mbc.verifyphone
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mgov.bee.kz/mbc/verifyphone", name = "verifyPhoneResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mgov.bee.kz/mbc/verifyphone", name = "verifyPhoneRequest")
