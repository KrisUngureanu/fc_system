 ...
 * generated in the kz.tamur.fc.aisoop.response package. 
...
public class ObjectFactory {
    ...
    private final static QName _Response_QNAME = new QName("http://mtczn.kz", "response");
    private final static QName _Request_QNAME = new QName("http://mtczn.kz", "request");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: kz.tamur.fc.aisoop.response
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MainMessage }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://mtczn.kz", name = "response")
    public JAXBElement<MainMessage> createResponse(MainMessage value) {
        return new JAXBElement<MainMessage>(_Response_QNAME, MainMessage.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtczn.kz", name = "request")
