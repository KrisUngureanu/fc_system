 ...
 *         &lt;element name="districts" type="{http://dictionaries.persistence.interactive.nat}District" minOccurs="0"/>
...
@XmlType(name = "RegAddress", propOrder = {
    "country",
    "districts",
    "region",
    "districtName",
...
public class RegAddress {
     ...
     *     
     */
    public void setDistricts(District value) {
